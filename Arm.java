public class Arm {
    ...
    public int findItemStation(){
        // possibly boolean coldSpace = section.coldCount()
        // possibly boolean weightSpace = section.weightCount()
        int i;
        ...
        // Item belongs in cold section
        if (isCold == true /*&& coldSpace == true */){
            return 5;
        }

        // Item belongs in light weight section
        ...
        /*  
            ...
            if (section1.numItemCheck() == false){
                itemSlot = section1.findItemSlot();
                return 1;
            }

            else if(section3.numItemCheck() == false){
                itemSlot = section1.findItemSlot();
                return 3;
            }

            else if(section5.numItemCheck() == false){
                itemSlot = section1.findItemSlot();
                return 5;
            }
        */
